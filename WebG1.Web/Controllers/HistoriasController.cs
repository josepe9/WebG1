...
namespace WebG1.Web.Controllers
{
    public class HistoriasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Fecha,AnimalId,EnfermedadId,Detalle,VeterinarioId")] Historia historia)
        {
            ...
            ViewData["VeterinarioId"] = new SelectList(_context.Veterinario, "Id", "Id", historia.VeterinarioId);
            return View(historia);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Fecha,AnimalId,EnfermedadId,Detalle,VeterinarioId")] Historia historia)
        {
            if (id != historia.Id)
            {
                return NotFound();
